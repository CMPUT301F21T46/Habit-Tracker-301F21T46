...
For neatness and readability, diagrams must be drawn well using a computer tool at a suitably legible scale for insertion into your document(s). Submitted diagram(s) must be embedded as image(s) in your team wiki, not linked externally. The UML diagram(s) may be reverse engineered from code, but must be edited, arranged, and selective (not a raw dump).
